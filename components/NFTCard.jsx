  ...
  return (
    <Link href={{ pathname: '/nft-details', query: nft }}>
      <motion.div
        ...
        className="flex-1 min-w-215 max-w-max xs:max-w-none sm:w-full sm:min-w-155 minmd:min-w-256 minlg:min-w-327 dark:bg-nft-black-3 bg-white rounded-2xl p-8 m-8 minlg:m-8 sm:my-2 sm:mx-2 cursor-pointer shadow-md hover:shadow-lg duration-500"
      >
        ...
        <div className="mt-3 flex flex-col">
          ...
          <div className="flexBetween mt-1 gap-2 minlg:mt-3 flex-row xs:flex-col xs:items-start xs:mt-3">
